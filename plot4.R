...
with(sub_data,plot(date_time,Global_active_power,type = "l", ylab = "Global_active_power", xlab = ""))

with(sub_data,plot(date_time,Voltage,type = "l", ylab = "Voltage", xlab = ""))
...
with(sub_data,plot(date_time,Global_reactive_power,type = "l", ylab = "Global_active_power", xlab = ""))
